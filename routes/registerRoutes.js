...
module.exports = function(app) {
    ...
    // 	    res.render('signup',
    // 		       {title:'Signup en ijif',fail:"Error: Promocional incorrecto; estamos en fase de pruebas y el registro requiere de invitación ... escribe a freising.denuevo en gmail para obtener una si te interesa ..."});
    // 	} else {
    // 	    next();
    // 	}
    // });
